document.addEventListener('DOMContentLoaded', function () {
  ...
  const navbar = document.querySelector('nav, .navbar, [class*="navbar"], header');
  ...
  if (contactForm) {
    ...
    function showFormSuccess() {
      ...
      successEl.textContent = contactForm.dataset.successMessage || 'Your message has been sent successfully!';
  ...
  const OBSERVE_SELECTOR = '.fade-in, [data-animate], .animate-on-scroll';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בני הממליץ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ee9b711c-0c87-40ab-a0d4-803b7d81952b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ee9b711c-0c87-40ab-a0d4-803b7d81952b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ee9b711c-0c87-40ab-a0d4-803b7d81952b';
